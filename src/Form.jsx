          ...
          <div className="container">
            ...
            {this.state.displayForm ? (
              <>
                ...
                <button onClick={this.showForm} className="btn btn-warning">Go Back</button>
              </>
            ) : null}
            {!this.state.displayForm ? (
              <form className="feed_form" >
                ...
                <label>
                  Rating:
                  <input type="text" value={this.state.rating} onChange={this.setRating} required/>
                </label>
                <button onClick={this.hideForm } className="btn btn-warning">Submit</button>
              </form>
            ) : null}
          </div>
        );
